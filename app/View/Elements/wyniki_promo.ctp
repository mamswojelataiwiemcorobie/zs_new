<div class="znajdz-wyniki">
	<?php foreach ($uczelnie_wyniki as $uw): 
		$slug=strtolower(Inflector::slug($uw['University']['nazwa'],'-'));?>
	<div class="item row">
		...
		<div class="data-c col-sm-8 row"><div class="data">
			<a href="/uczelnia/<?php echo $slug.'-'.  $uw['University']['id'];?>.html" class="title"><h3><?php echo $uw['University']['nazwa'];?></h3></a>
			<div class="data-l col-md-8">
				...
				<?php if ($uw['UniversitiesParameter']['opis']):?>
					<span><?php echo $this->Text->truncate(
						...
						<a href="/uczelnia/<?php echo $slug.'-'.  $uw['University']['id'];?>.html">&gt;&gt; WIĘCEJ</a>
					</span>
				<?php endif;?>
			</div>
			<div class="data-r col-md-4">
				...
				<a href="/uczelnia/<?php echo $slug.'-'.  $uw['University']['id'];?>/KIERUNKI-5" class="uczelnia-kierunki btn btn-large btn-primary">
