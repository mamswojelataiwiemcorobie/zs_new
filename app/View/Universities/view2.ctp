						...
						<div class="btn-group-vertical linki">
							...
							<button type="button" class="btn btn-default btn-lg">
								...
								<a href="<?php $slug = Inflector::slug($university['University']['nazwa'],'-');
									...
									echo 'http://www.zostanstudentem.pl/uczelnia/'.$slug.'-'.$university['University']['id'].".html";?>" alt="Zobacz więcej"><span class="glyphicon glyphicon-th"></span> Zobacz więcej</a>
						...
						<div class="btn-group-vertical linki">
							...
							<button type="button" class="btn btn-default btn-lg">
								...
								<a href="<?php $slug = Inflector::slug($university2['University']['nazwa'],'-');
									...
									echo 'http://www.zostanstudentem.pl/uczelnia/'.$slug.'-'.$university2['University']['id'].".html";?>" alt="Zobacz więcej"><span class="glyphicon glyphicon-th"></span> Zobacz więcej</a>
